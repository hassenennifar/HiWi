...
%         Eeq = Eeq_neg(0.8, P);
        ...
        phis_bnd_sep_neg = eta+phil(P.bnd_sep_neg)+Eeq+P.Rf_neg*P.F*jn(P.bnd_sep_neg);
        
        g = -x(P.nj*P.nx+1,k)+(phis(P.bnd_pos_sep)+il_pos+il_neg-phis_bnd_sep_neg-x(P.nj*P.nx+2,k))/(P.L_pos/P.sigma_pos+P.L_neg/P.sigma_neg+P.RG);
        Jrow(P.nj*P.nx+1) = -1;
else
