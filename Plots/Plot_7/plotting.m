...
mat{1} = load('Duhamel_Pulse_CV_2.5C.mat');
mat{2} = load('Duhamel_Pulse_CV_2.5C_Polynomial_EKF_results.mat');
mat{3} = load('Duhamel_Pulse_CV_2.5C_Eigenvalues_EKF_results.mat');
