...
P.L_neg = 86.667e-6;  % thickness of negative electrode (m)
P.L_sep = 12e-6;  % thickness of separator (m)
P.L_pos = 66.667e-6;  % thickness of positive electrode (m)

P.hcn = 11e-06;  % thickness of negative electrode current collector (m)
P.hcp = 35.667e-06;  % thickness of positive electrode current collector (m)

P.cl0 = 1000;  % initial electrolyte concentration (mol/m3)
P.sto_neg = 0.8;  % initial stochiometric parameter for negative particle
P.sto_pos = 0.6240;  % initial stochiometric parameter for positive particle
...
P.Rp_neg = 6.0840e-6;  % radius of negative particles (m)
P.Rp_pos = 5e-6;  % radius of positive particles (m)

P.epsl_neg = 0.5379;  %  volume fraction of electrolyte in negative electrode
