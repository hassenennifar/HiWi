...
Eeq(1:P.bnd_sep_neg) = Eeq_neg(utz(1:P.bnd_sep_neg,k), P, cur);
dEeqdT(1:P.bnd_sep_neg) = dEeqdT_neg(utz(1:P.bnd_sep_neg,k), P);

% utz(P.bnd_pos_sep:P.nj,k) = css(P.bnd_pos_sep:P.nj,k)/P.csmax_pos;
Eeq(P.bnd_pos_sep:P.nj) = Eeq_pos(utz(P.bnd_pos_sep:P.nj,k), P);
dEeqdT(P.bnd_pos_sep:P.nj) = dEeqdT_pos(utz(P.bnd_pos_sep:P.nj,k), P);
