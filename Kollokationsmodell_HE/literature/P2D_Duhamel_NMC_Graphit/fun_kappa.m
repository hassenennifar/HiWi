...
% eff = 1;
% cl = cl/1e6;
% factor = -10.5+6.68e2*cl+0.074*P.T-1.78e1*P.T*cl-6.96e-5*P.T.^2+2.8e-2*cl*P.T.^2+4.94e5*cl.^2-8.86e2*cl.^2*P.T;
% kappa =  0.1*cl.*factor.^2*eff*1e3; % electrolyte kappa [S/mm]
% dfactor_dcl = (6.68e2-1.78e1*P.T+2.8e-2*P.T.^2)+(4.94e5-8.86e2*P.T)*2*cl;
